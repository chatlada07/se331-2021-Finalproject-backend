package se331.project.backend.security.controller;
...
public class AuthenticationRestController {
    ...
    @PostMapping("${jwt.route.authentication.path}/vanda")
